...
urlpatterns = [
    ...
    # path('RoyaltyFreeSearchApp/register/', accounts_views.register, name='register'),
    # path('RoyaltyFreeSearchApp/login/', accounts_views.user_login, name='login'),
    # path(
    #     'RoyaltyFreeSearchApp/logout/',
